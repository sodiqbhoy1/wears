...
export async function sendOrderConfirmationEmail(orderDetails) {
  try {
    ...
    const mailOptions = {
      ...
      subject: `Order Confirmation - Order #${orderDetails.reference}`,
...
function generateOrderConfirmationHTML(orderDetails) {
  ...
  const trackingUrl = `${process.env.NEXT_PUBLIC_BASE_URL || 'http://localhost:3000'}/track-order?code=${reference}`;
  ...
  return `
    ...
    <head>
        ...
        <style>
            ...
            .content { padding: 20px; background: #f9f9f9; }
            .tracking-code { background: #fff; padding: 15px; border: 2px solid #000; text-align: center; margin: 20px 0; }
            ...
            .footer { text-align: center; padding: 20px; color: #666; }
            .button { display: inline-block; background: #000; color: white; padding: 12px 24px; text-decoration: none; border-radius: 5px; margin: 10px; }
        </style>
    </head>
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <div style="background: #f8f9fa; padding: 15px; border-radius: 5px; text-align: center;">
                    ...
                    <p>Your order is successful and will be ready for delivery soon.</p>
                    <p>Use the tracking code below to check your order status:</p>
            ...
            <div class="footer">
                ...
                <p>WearHouse - Quality fashion delivered to you!</p>
            </div>
        </div>
    </body>
    </html>
...
WHAT HAPPENS NEXT:
- Your order is successful and will be ready for delivery soon.
- You can track your order status using the link below:
${trackingUrl}
- Or check manually with your tracking code: ${reference}

Need help? Contact us at ${process.env.EMAIL_USER}

WearHouse - Quality fashion delivered to you!
  `;
}
