                            ...
                            return (
                                ...
                                >
                                    <div className="relative w-full aspect-square">
                                        <Image 
                                            src={selectedVariant?.image || (item.images && item.images[0]) || item.image || '/placeholder.svg'} 
                                            alt={item.name} 
                                            layout="fill" 
                                            objectFit="cover" 
                                        />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6">
                        ...
                        <div className="relative w-full aspect-square rounded-lg overflow-hidden">
                            {(() => {
                                ...
                                return (
                                    <Image 
                                        src={selectedVariant?.image || (selectedProduct.images && selectedProduct.images[0]) || selectedProduct.image || '/placeholder.svg'} 
